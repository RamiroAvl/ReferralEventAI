...
export const redisTool = tool({
  description: `
    ...
    - Um hash chamado "referral:access-count" que guarda o número de cliques/acessos no link de convite/indicação de cada usuário no formato { "SUBSCRIBER_ID": NUMERO DE CLIQUES } onde o SUBSCRIBER_ID vem do Postgres.
